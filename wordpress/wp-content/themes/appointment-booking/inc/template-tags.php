 ...
 * Posts pagination.
 */
if ( ! function_exists( 'appointment_booking_blog_posts_pagination' ) ) {
	function appointment_booking_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'appointment_booking_blog_pagination_type', 'blog-page-numbers' );
