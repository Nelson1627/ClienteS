...
class Appointment_Booking_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Appointment_Booking_About_Widget',
			__('VW About us', 'appointment-booking'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'appointment-booking' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','appointment-booking'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','appointment-booking'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','appointment-booking'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','appointment-booking'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','appointment-booking'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','appointment-booking'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function appointment_booking_about_custom_load_widget() {
	register_widget( 'Appointment_Booking_About_Widget' );
}
add_action( 'widgets_init', 'appointment_booking_about_custom_load_widget' );