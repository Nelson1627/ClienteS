...
class Appointment_Booking_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'appointment-booking' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $appointment_booking_font_awesome_icon_array = appointment_booking_font_awesome_icon_array();
                    foreach ($appointment_booking_font_awesome_icon_array as $appointment_booking_font_awesome_icon) {
                            $icon_class = $this->value() == $appointment_booking_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($appointment_booking_font_awesome_icon).'"></i>
                            <span class="appointment-booking-social-class">'.esc_attr($appointment_booking_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function appointment_booking_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'appointment-booking-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'appointment_booking_customizer_script' );

if(!function_exists('appointment_booking_font_awesome_icon_array')){
    function appointment_booking_font_awesome_icon_array(){
